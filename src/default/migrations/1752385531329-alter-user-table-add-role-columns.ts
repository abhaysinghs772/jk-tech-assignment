...
export class AlterUserTableAddRoleColumns1752385531329 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_roles_enum" AS ENUM('admin', 'editor', 'viewer')`);
        ...
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "roles" SET DEFAULT 'viewer'`);
